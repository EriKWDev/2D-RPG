...
namespace PixelCrushers.DialogueSystem
{
    ...
    public class WelcomeWindow : EditorWindow
    {
        ...
        public const string ShowOnStartEditorPrefsKey = "PixelCrushers.DialogueSystem.WelcomeWindow.ShowOnStart";

        [MenuItem("Window/Dialogue System/Welcome Window", false, -1)]
        public static void Init()
        {
            var window = GetWindow(typeof(WelcomeWindow), false, "Welcome") as WelcomeWindow;
            window.minSize = new Vector2(370, 280);
            window.showOnStart = EditorPrefs.GetBool(ShowOnStartEditorPrefsKey, true);
        }
        ...
        {
            EditorApplication.update -= CheckShowWelcomeWindow;
            if (EditorPrefs.GetBool(ShowOnStartEditorPrefsKey, true))
            {
                Init();
            }
        }
        ...
        private void DrawFooter()
        {
            ...
            if (newShowOnStart != showOnStart)
            {
                ...
                EditorPrefs.SetBool(ShowOnStartEditorPrefsKey, showOnStart);
            }
